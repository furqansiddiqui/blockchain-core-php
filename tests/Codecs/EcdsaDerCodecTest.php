...
class EcdsaDerCodecTest extends TestCase
{
    ...
    public function testDecodeBasic(): void
    {
        ...
        [$decodedR, $decodedS] = EcdsaDerCodec::decode(Curve::Secp256k1, $der);
    ...
    public function testDecodeBIP66InvalidTag(): void
    {
        ...
        EcdsaDerCodec::decode(Curve::Secp256k1, "\x31\x06\x02\x01\x01\x02\x01\x01");
    }

    public function testDecodeBIP66InvalidLength(): void
    {
        $this->expectException(\LengthException::class);
        EcdsaDerCodec::decode(Curve::Secp256k1, "\x30\x07\x02\x01\x01\x02\x01\x01");
    }

    public function testDecodeBIP66InvalidRTag(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        EcdsaDerCodec::decode(Curve::Secp256k1, "\x30\x06\x03\x01\x01\x02\x01\x01");
    }

    public function testDecodeBIP66InvalidSTag(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        EcdsaDerCodec::decode(Curve::Secp256k1, "\x30\x06\x02\x01\x01\x03\x01\x01");
    }

    public function testDecodeBIP66NegativeR(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        EcdsaDerCodec::decode(Curve::Secp256k1, "\x30\x06\x02\x01\x80\x02\x01\x01");
    }

    public function testDecodeBIP66NonMinimalR(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        EcdsaDerCodec::decode(Curve::Secp256k1, "\x30\x07\x02\x02\x00\x01\x02\x01\x01");
    }

    public function testDecodeBIP66RedundantZerosR(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        EcdsaDerCodec::decode(Curve::Secp256k1, "\x30\x08\x02\x03\x00\x00\x80\x02\x01\x01");
    }

    public function testDecodeBIP66TrailingBytes(): void
    {
        $this->expectException(\LengthException::class);
        EcdsaDerCodec::decode(Curve::Secp256k1, "\x30\x06\x02\x01\x01\x02\x01\x01\xff");
    }
    ...
    public function testDecodeTooLargeR(): void
    {
        ...
        EcdsaDerCodec::decode(Curve::Secp256k1, $der);
    }
